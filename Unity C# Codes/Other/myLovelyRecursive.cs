List<Tile> RecursiveLayerByLayer21Finder(int sum, int currentLayer, int beforeLayerINumber, int tryOutAmount, List<Tile> returnList)
        ...
        //var ordered = tiles.Where(tile => tile.isLocked).OrderBy(tile => tile.transform.position.z).ToList();
        //var unlockeds = tiles.Where(tile => !tile.isLocked).ToList();
        //unlockeds.Shuffle();

        //var hammers = new List<Tile>();

        //int sum = 0;

        //int amount = (unlockeds.Count < 5 ? unlockeds.Count : 5);
        //for (int i = 0; i < amount; i ++)
        //{
        //    Tile tile = unlockeds[i];
        ...
        //    foreach(Tile tile in ordered)
        //    {
        //        if (sum + tile.value > 21)
        //        {
        //            sum += tile.value;
        //            hammers.Add(tile);
        //            removal = tile;
        ...
        //    if (sum > 21)
        //    {
        //        ordered.Remove(removal);
        //    }
        //    else
        //    {
        //        hammers.Add(ordered[0]);
        ...
        //void Execute()
        //{
        //    foreach(Tile tile in hammers)
        //    {
        //        tiles.Remove(tile);
        //        tile.OnPop?.Invoke(tile, true);
        //        tile.transform.GetChild(3).GetComponent<SpriteRenderer>().color = Color.red;
